class ObjetTP {
  ...
  public void setImageUp(PImage imageUp) {
  ...
  public void setImageDown(PImage imageDown) {
    this.imageDown = imageDown;
  }

  public PImage getImageFace() {
    return imageFace;
  }

  public void setImageFace(PImage imageFace) {
    this.imageFace = imageFace;
  }

  public PImage getImageDerriere() {
    return imageDerriere;
  }

  public void setImageDerriere(PImage imageDerriere) {
    this.imageDerriere = imageDerriere;
  }

  public PImage getImageGauche() {
    return imageGauche;
  }

  public void setImageGauche(PImage imageGauche) {
    this.imageGauche = imageGauche;
  }

  public PImage getImageDroite() {
    return imageDroite;
  }

  public void setImageDroite(PImage imageDroite) {
  ...
  public void setColorR(int x) {
    colors[0] = x;
  }

  public void setColorG(int x) {
    colors[1] = x;
  }

  public void setColorB(int x) {
    colors[2] = x;
  }
  ...
  public void setTranslateX(int tran) {
    this.translateX = tran;
  }
  ...
  public void setTranslateY(int tran) {
    this.translateY = tran;
  }
  ...
  public void setTranslateZ(int tran) {
    this.translateZ = tran;
  }

  public int getTransFill() {
    return transFill;
  }

  public void setTransFill(int tran) {
    this.transFill = tran;
  }
  ...
  public void setColorFill(int col) {
    this.colorFill = col;
  }
}
