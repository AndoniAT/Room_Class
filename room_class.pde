...
PImage floorImage, tableImage, chairImage, floorImage1, keyboard, mureImage, tableauImage, roofImage, lhImage, goutteImage, porteImage;
...
void setup() {
  ...
  int grosZ = 300;
  xPiedADEH = -x + 400;
  xBCFG    = xPiedADEH + grosX;
  yABEF     = -y - 30;
  yCDGH    = yABEF - 30;
  profABCD  = z - grosZ;
  profEFGH = profABCD - grosZ;
  ...
  obj.setRotateY(rotY);
  obj.setRotateZ(rotZ);
  obj.setTranslateX(transX);
  obj.setTranslateY(transY);
  obj.setTranslateZ(transZ);
  objets = (PShape[]) append(objets, creerTable(obj, 1, 0));

  xPiedADEH  = xPiedADEH + grosX/2;
  xBCFG    = xPiedADEH + 20;
  yABEF      = yCDGH - hauteur/2;
  ;
  yCDGH    = yABEF + hauteur/2;
  profABCD   = z - grosZ - grosZ/2 + 20;
  profEFGH = profABCD - 40;
  ...
  xBCFG    = xPiedADEH + 10;
  yABEF      = yABEF + 250 ;
  yCDGH    = yCDGH - hauteur/2 - 100;
  profABCD  = z - grosZ +100;
  profEFGH = profABCD - grosZ - 200;
  ...
  objScreen.setColorR(0);
  obj.setColorG(0);
  obj.setColorB(0);
  //objScreen.setImageDroite(lhImage);
  objScreen.setRotateX(rotX);
  objScreen.setRotateY(rotY);
  objScreen.setRotateZ(rotZ);
  objScreen.setTranslateX(transX);
  objScreen.setTranslateY(transY);
  objScreen.setTranslateZ(transZ);
  ...
  profEFGH = z+10;
  obj = creerObjects(xPiedADEH, xBCFG, yABEF, yCDGH, profABCD, profEFGH);
  obj.setImageFace(mureImage);
  obj.setImageDerriere(mureImage);
  objets = (PShape[]) append(objets, creerTable(obj, 1, 0));
  ...
  for (int i = 0; i < 3; i++) {
    ...
    obj.setTransFill(100);
    obj.setColorFill(255);
    objets = (PShape[]) append(objets, creerTable(obj, 1, 0));
  }
  xPiedADEH += dist;
  xBCFG = xPiedADEH - dist;
  obj = creerObjects(xPiedADEH, xBCFG, yABEF, yCDGH, profABCD, profEFGH);
  obj.setTransFill(100);
  obj.setColorFill(255);
  objets = (PShape[]) append(objets, creerTable(obj, 1, 0));
  ...
  yABEF =y - 200;
  yCDGH = -hauteur+200;
  profABCD = profABCD+50;
  profEFGH= (profEFGH/2)-100;
  obj = creerObjects(xPiedADEH, xBCFG, yABEF, yCDGH, profABCD, profEFGH);
  ...
  xPiedADEH = -x+200+ 300;
  xBCFG = -x+200;
  yABEF = -hauteur + (hauteur/5);
  yCDGH = y;
  profABCD = -z-20;
  profEFGH = profABCD+40;
  obj = creerObjects(xPiedADEH, xBCFG, yABEF, yCDGH, profABCD, profEFGH);
  obj.setImageFace(porteImage);
  obj.setImageDerriere(porteImage);
  obj.setColorR(0);
  obj.setColorG(0);
  obj.setColorB(0);
  objets = (PShape[]) append(objets, creerTable(obj, 1, 0));
  ...
  int grossTable = 14;
  int diff = 100;
  int largeurMoitieTable = 300;
  xPiedADEH = -x - largeurMoitieTable ;
  xBCFG = xPiedADEH + largeurMoitieTable;
  yABEF = -y -diff - grossTable;
  yCDGH = yABEF+20;
  profABCD = 40;
  profEFGH = profABCD + (-z/2) + 10;
  obj = creerObjects(xPiedADEH, xBCFG, yABEF, yCDGH, profABCD, profEFGH);
  obj.setImageFace(floorImage);
  obj.setImageUp(tableImage);
  obj.setImageDown(floorImage);
  obj.setImageGauche(floorImage);
  obj.setImageDroite(floorImage);
  obj.setImageDerriere(floorImage);

  objets = (PShape[]) append(objets, creerTable(obj, 1, 0));

  int z2 = 40;
  xPiedADEHTemp = xPiedADEH;
  int xBCFGTemp;
  int yABEFTemp;
  int yCDGHTemp;
  int profABCDTemp;
  ...
  for (int j = 1; j <= 4; j++) {
    ...
    if (j == 3 || j == 4) {
      zPied = profABCD - (z/2) + 10;
      zinc = -7;
    }

    xPiedADEHTemp = -x - largeurMoitieTable - xPied1;
    xBCFGTemp = xPiedADEHTemp + xPied2;
    yABEFTemp = -y-diff;
    yCDGHTemp = -y;
    profABCDTemp = zPied;
    profEFGHTemp = profABCDTemp - zinc;
  ...
  for (int j = 1; j <= 4; j++) {
    ...
    if (j == 1 || j == 3) { xPiedADEH = x + 140 ;            xPied2 = -10; }
    if (j == 2 || j == 4) { xPiedADEH += largeurMoitieTable; xPied2 = +10; }
    if (j == 1 || j == 2) { zPied = profABCD;                zinc = 7;     }
    if (j == 3 || j == 4) { zPied = profABCD - (z/2) + 10;   zinc = -7;    }

    /*xPiedADEHTemp = x + xPied1;*/
    xBCFG = xPiedADEH - xPied2;
    yABEFTemp = -y-diff;
    yCDGHTemp = -y;
    profABCDTemp = zPied;
    profEFGHTemp = profABCDTemp - zinc;

    obj = creerObjects(xPiedADEH, xBCFG, yABEFTemp, yCDGHTemp, profABCDTemp, profEFGHTemp);
    obj.setColorR(0);
    obj.setColorG(0);
    obj.setColorB(0);
    objets = (PShape[]) append(objets, creerTable(obj, 1, 0));
...
PShape[] createElementsTable(int x, int y, int z) {
  ...
  int xPied1 = largeurMoitieTable, xPied2 = 25, zPied = z2, zinc = 20;
  for (int i = 1; i <= 2; i++ ) {
    xPiedADEH = -largeurMoitieTable - (x/2);
    xBCFG = largeurMoitieTable - (x/2);
    yABEF = -y -diff - grossTable;
    yCDGH = -y -diff;
    if (i == 1) {
      profABCD = z2;
  ...
  for (int i = 1; i <= 4; i++) {
    ...
    xPiedADEH = -(x/2) + largeurMoitieTable   - x3;
    xBCFG = -(x/2) + largeurMoitieTable   - 10;
    yABEF = -y - diff - grossTable-5;
    yCDGH = yABEF+5;
    profABCD = prof;
    profEFGH = prof-zinc;
  ...
  for (int i = 1; i <= 4; i++) {
    ...
    xPiedADEH = xBase  - x3;
    xBCFG = xPiedADEH + 20;
    yABEF = -y - diff - grossTable - 100 + 80 ;
    yCDGH = -y - diff - grossTable - 100;
    profABCD  = prof+30;
    profEFGH = profABCD-zinc;
    ...
    case 1 :
      {
        obj.setImageDroite(vsStudioImage);
        break;
      }
    case 2 :
      {
        obj.setImageDroite(classImage);
        break;
      }
    }
    ...
    xPiedADEH = xBase  - x3;
    xBCFG = xPiedADEH + 80;
    yABEF     = -y - diff - grossTable- 90;
    yCDGH = -y - diff - grossTable;
    profABCD  = prof-90 ;
    profEFGH = profABCD-zinc;
    ...
    obj.setColorG(0);
    obj.setColorB(0);
    obj.setImageGauche(pcBackImage);
    obj.setImageDroite(pcFaceImage);
    tab = (PShape[]) append(tab, creerTable(obj, 1, 0));
  }
  ...
  for (int inc = 1; inc <= 4; inc++) {
    ...
    xPiedADEH = - (x/2) - largeurMoitieTable  + x3;
    xBCFG = - (x/2) + largeurMoitieTable  + 40;
    yABEF = -y - (diff/2) - grossTable;
    yCDGH = -y - (diff/2);
    profABCD = -prof;
    profEFGH = profABCD+90;


    obj = creerObjects(xPiedADEH, xBCFG, yABEF, yCDGH, profABCD, profEFGH);
    obj.setImageFace(chairImage);
    obj.setImageUp(chairImage);
    obj.setImageDown(chairImage);
    obj.setImageGauche(chairImage);
    obj.setImageDroite(chairImage);
    obj.setImageDerriere(chairImage);
    ...
    for (int j = 1; j <= 4; j++) {
      ...
      xPiedADEH = - (x/2) - largeurMoitieTable  + xtemp;
      xBCFG = - (x/2) + largeurMoitieTable  + 50;
      yABEF = -y - (diff/2) - grossTable - ytemp ;
      yCDGH = yABEF + 80 ;
      profABCD = -prof;
      profEFGH = profABCD+90;
    ...
    for (int j = 1; j <= 4; j++) {
      ...
      xPiedADEH = - (x/2) - largeurMoitieTable  + xPied1;
      xBCFG = - (x/2) + largeurMoitieTable  - xPied2;
      yCDGH = -y;
      profABCD = zPied;
      profEFGH = profABCD-zinc;
      obj = creerObjects(xPiedADEH, xBCFG, yABEF, yCDGH, profABCD, profEFGH);
...
PShape creerTable(ObjetTP obj, int xx, int yy) {
  ...
  } else if (obj.getImageFace() != null) {
    face_1.texture(obj.getImageFace());
  } else {
    face_1.fill(obj.getColorR(), obj.getColorG(), obj.getColorB());
  }
  ...
  if (obj.getTransFill() > 0 && obj.getColorFill() > 0) {
    ...
    face_2.fill(obj.getColorR(), obj.getColorG(), obj.getColorB());
  }
  ...
  } else if (obj.getImageDown() != null) {
    face_3.texture(obj.getImageDown());
  } else {
    face_3.fill(obj.getColorR(), obj.getColorG(), obj.getColorB());
  }
  ...
  } else if (obj.getImageDerriere() != null) {
    face_4.texture(obj.getImageDerriere());
  } else {
    face_4.fill(obj.getColorR(), obj.getColorG(), obj.getColorB());
  }
  ...
  } else if (obj.getImageGauche() != null) {
    face_5.texture(obj.getImageGauche());
  } else {
    face_5.fill(obj.getColorR(), obj.getColorG(), obj.getColorB());
  }
  ...
  } else if (obj.getImageDroite() != null) {
    face_6.texture(obj.getImageDroite());
  } else {
    face_6.fill(obj.getColorR(), obj.getColorG(), obj.getColorB());
  }
...
void updateCamera() {
  ...
  if (keyPressed) {
    if (key == 'w' || key == 'z') { // devant
      cameraZ -= cameraSpeed;
    } else if (key == 's') { // derriere
      cameraZ += cameraSpeed;
    } else if (key == 'q') { //
      cameraX -= cameraSpeed;
    } else if (key == 'd') {
